...
#define CUSTOM_MACHINE_NAME "StubbsPKS"
...
#define ENDSTOP_INTERRUPTS_FEATURE // MM 04-12-19
...
#define BLTOUCH
#if ENABLED(BLTOUCH)
  #define BLTOUCH_DELAY 100   // (ms) Enable and increase if needed //MM 04-12-19
  ...
  #define BLTOUCH_V3
    ...
    #define BLTOUCH_FORCE_OPEN_DRAIN_MODE //MM 04-12-19
  #endif
#endif
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //MM 04-12-19
